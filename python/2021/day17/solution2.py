...
t1 = threading.Thread(target=calculateMaxHight, args=(xArea,yArea,-300,-200,500,areaCords))
t2 = threading.Thread(target=calculateMaxHight, args=(xArea,yArea,-200,-100,500,areaCords))
t3 = threading.Thread(target=calculateMaxHight, args=(xArea,yArea,-100,0,500,areaCords))
t4 = threading.Thread(target=calculateMaxHight, args=(xArea,yArea,0,100,500,areaCords))
t5 = threading.Thread(target=calculateMaxHight, args=(xArea,yArea,100,200,500,areaCords))
t6 = threading.Thread(target=calculateMaxHight, args=(xArea,yArea,200,300,500,areaCords))
