...
allCombinations = getAllCombinations(containers, 150, max([x[0] for x in containers]))
containerCounts = [len(combination) for combination in allCombinations]
print(containerCounts.count(min(containerCounts)))